...
const Footer = () => {
  return (
    <section className=" pt-20 bg-gradient-to-r from-[#E5F1FF] to-[#B5D8FF] via-[#E5F1FF] via-65% dark:bg-gradient-to-r dark:from-[#151C25] dark:via-[#151C25] dark:via-50% dark:to-[#4F698B] dark:text-white">
      <div className="max-w-7xl mx-auto sm:px-6 px-4 lg:px-16">
        <div className="flex justify-between border-b-2 border-primary flex-col md:flex-row">
          ...
          <div className="pt-16 flex space-x-4">
            ...
            <a href="">
              <img src={linkedIn} alt="linkedin" className="size-12" />
            </a>
            <a href="">
            ...
            <a href="">
              <img src={twitter} alt="twitter" className="size-12" />
            </a>
          </div>
        </div>
